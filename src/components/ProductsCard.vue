    ...
    <div v-for="(product, index) in products" :key="product.id"
        ...
        <div class="card-body">
            ...
            <div class="flex gap-1">
                <div class="badge badge-lg bg-secondary-focus font-bold">Ksh {{ product.price }}
                </div>
                <!-- <div class="badge badge-lg badge-accent font-bold">Stock: {{ product.quantity }}</div> -->
                <div class="badge badge-lg bg-accent-focus font-bold">Item(s) Added : <span class="text-black">
            ...
            <div class="card-actions justify-end">
                ...
                <div v-else class="grid grid-cols-3 gap-1">
                    ...
                    <button @click="removeCartProducts(product)" class="btn btn-sm bg-error-content">
